        ...
        for (reference, condition_id), agg_data in tqdm(aggregated.items(), desc="Processing aggregated products"):
            try:
                ...
                if existing_price:
                    ...
                    # Product doesn't exist, look for SKU
                    if not product_id:
                    ...
                    if not product_id:
                        ...
                        category_id = None  # FIX: shadow outer condition_id avoided by using local var
                        ...
                        # Safe None guards — avoids pd.isna() which raises TypeError on Decimal/str
